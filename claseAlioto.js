...
if(selection === 0){
    choose.innerHTML = "Muchas gracias por su interes. Sigannos en Instagram para ver reseñas diarias!";
}else if(selection === 100){
    choose.innerHTML(mostrarPrecios());
};
